...
describe('MoveParser', () => {
  ...
  describe('parse - move handling', () => {
    ...
    it('should parse multiple separate moves', () => {
      ...
      const initialResult2 = new ParseResult(result1.instructions, result1.boardSize, result1.coordinateSides, result1.errors, result1.viewport, result1.showHoshi, result1.customHoshiPoints);
      const result2 = parser.parse('W A2', 2, initialResult2);

      const initialResult3 = new ParseResult(result2.instructions, result2.boardSize, result2.coordinateSides, result2.errors, result2.viewport, result2.showHoshi, result2.customHoshiPoints);
      const result3 = parser.parse('B C1-E3, F1-F9', 3, initialResult3);

      const initialResult4 = new ParseResult(result3.instructions, result3.boardSize, result3.coordinateSides, result3.errors, result3.viewport, result3.showHoshi, result3.customHoshiPoints);
